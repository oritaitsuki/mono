class UserItemAddress
  ...
  attr_accessor :post_number, :city, :address, :phone_number, :building_name, :place_id, :user_item_id, :item_id, :user_id,
                :token
  ...
  def save
    ...
    Address.create(post_number: post_number, place_id: place_id, city: city, address: address,
